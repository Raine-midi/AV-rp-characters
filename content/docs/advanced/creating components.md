---
{"publish":true,"title":"Creating your own Quartz components","created":"2025-08-14T17:29:12.141+02:00","modified":"2025-08-14T17:29:12.141+02:00","cssclasses":""}
---
...
- `fileData`: Any metadata [[docs/advanced/making plugins\|plugins]] may have added to the current page.
...
You can also add the equivalent of a `beforeunload` event for [[docs/features/SPA Routing]] via the `prenav` event.
