---
{"publish":true,"title":"Making your own plugins","created":"2025-08-14T17:29:12.142+02:00","modified":"2025-08-14T17:29:12.143+02:00","cssclasses":""}
---
...
A good example of a transformer plugin that borrows from the `remark` and `rehype` ecosystems is the [[docs/plugins/Latex\|Latex]] plugin:
...
- Your component should use `getQuartzComponents` to declare a list of `QuartzComponents` that it uses to construct the page. See the page on [[docs/advanced/creating components]] for more information.
