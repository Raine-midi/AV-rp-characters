---
{"publish":true,"title":"Migrating from Quartz 3","created":"2025-08-14T17:29:12.191+02:00","modified":"2025-08-14T17:29:12.192+02:00","cssclasses":""}
---
...
4. **A new extensible [[docs/configuration]] and [[docs/configuration#Plugins\|plugin]] system**: Quartz 3 was hard to configure without technical knowledge of how Hugo's partials worked. Extensions were even hard to make. Quartz 4's configuration and plugin system is designed to be extended by users while making updating to new versions of Quartz easy.
...
- [[docs/features/folder and tag listings\|Folder and tag listings]] have also changed.
...
- If you customized the layout of Quartz 3, you may need to translate these changes from Go templates back to JSX as Quartz 4 no longer uses Hugo. For components, check out the guide on [[docs/advanced/creating components]] for more details on this.
