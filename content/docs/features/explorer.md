---
{"publish":true,"title":"Explorer","created":"2025-08-14T17:29:12.155+02:00","modified":"2025-08-14T17:29:12.155+02:00","tags":["component"],"cssclasses":""}
---
...
- Changing `sort`, `filter` and `map` behavior: explained in [[docs/features/explorer#Advanced customization]]
...
You can pass your own functions for `sortFn`, `filterFn` and `mapFn`. All functions will be executed in the order provided by the `order` option (see [[docs/features/explorer#Customization]]). These functions behave similarly to their `Array.prototype` counterpart, except they modify the entire `FileNode` tree in place instead of returning a new one.
